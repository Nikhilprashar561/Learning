...
-- SELECT name, nickname, auction_price_crores FROM ipl_players ORDER BY auction_price_crores DESC LIMIT 3 offset 3;



-- SELECT name, team, (auction_price_crores * 100) AS new_be FROM ipl_players;
...
-- SELECT * FROM ipl_players WHERE team IN ('KKR', 'CSK', 'RCB', 'LSG');
...
-- SELECT team, name, nickname, auction_price_crores FROM ipl_players ORDER BY team ASC, auction_price_crores DESC;